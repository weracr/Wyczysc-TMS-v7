...
public class MainActivity extends Activity {
    ...
    private void showRepairDialog() {
        new AlertDialog.Builder(this)
                ...
                .setMessage("Aplikacja wykona proces ręcznie krok po kroku. Najpierw odinstaluj TMS, potem wróć do panelu administratora i użyj instalacji z pliku APK, jeśli test tego wymaga.")
    ...
    private void installTmsFromAssets() {
        try {
            ...
            Toast.makeText(
                    this,
                    "Brak app/src/main/assets/tms.apk albo błąd instalacji: " + e.getMessage(),
                    Toast.LENGTH_LONG
            ).show();
        }
    }
